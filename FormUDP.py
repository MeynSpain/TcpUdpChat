...
from Connect import ConnectUDP
...
class UsernameWindow(QWidget):
    def __init__(self):
        ...
        self.input_port = QLineEdit("55555")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, username, host, port):
        ...
        self.connectUDP = ConnectUDP(self.receive_message)
        self.connectUDP.connect(nickName=username, host=host, port=int(port))

        self.setWindowTitle(f"UDP  :  {username}")
